"""
Django settings for the ride management project.
"""
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Change this to allow unauthenticated access by default
    ],
}
